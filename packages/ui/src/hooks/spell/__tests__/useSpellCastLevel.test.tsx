...
import type { Character, Spell, SpellLevel } from 'open20-core';
...
describe('useSpellCastLevel', () => {
  ...
  it('resets selected level when available slots change', () => {
    ...
    const { result, rerender } = renderHook(
      ...
      { initialProps: { character: null as unknown as Character } },
    );
  ...
  it('handles undefined character gracefully', () => {
    const { result } = renderHook(() => useSpellCastLevel(upcastSpell, undefined));
